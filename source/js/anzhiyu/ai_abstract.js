(function () {
  ...
  const aiTitleRefreshIcon = post_ai.querySelector(".ai-title .iconfont.iagm-arrow-rotate-right");
  let aiReadAloudIcon = post_ai.querySelector(".iagm-circle-dot");
  ...
  async function readAloud() {
    ...
    aiReadAloudIcon = post_ai.querySelector(".iagm-circle-dot");
